...
for epoch in range(EPOCH):
    for step, (b_x, b_y) in enumerate(train_loader):  # 分配batch data
        ...
        if step % 1000 == 0:
            ...
            plt.plot(x_plt, y_plt, color='green', linewidth=2.0, linestyle='--')
            plt.text(5,0.5,r'$This\ is\ the\ train_loss$',fontdict={'size':16,'color':'pink'})
        ...
        plt.plot(x_acc, y_acc, color='pink', linewidth=2.0, linestyle='--')
        plt.text(5,0.5,r'$This\ is\ the\ Test_accuracy$',fontdict={'size':16,'color':'green'})
plt.ioff()  #关闭交互模式
plt.show()
